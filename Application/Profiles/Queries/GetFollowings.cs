...
public class GetFollowings
{
    ...
    {
        //Default value to get the followers o followings list
        ...
        : IRequestHandler<Query, Result<List<UserProfile>>>
    {
        public async Task<Result<List<UserProfile>>> Handle(Query request, CancellationToken cancellationToken)
        {
            ...
            {
                case "followers":
                    //Seguidores: Quienes ven al usuario?
                    //Los que siguen al target = usuario
                ...
                case "followings":
                    //Seguidos: A quienes ve el usuario?
                    //Los que el usuario observa, es decir sus target
